...
COMMAND_LEXICON = {
    ...
    "check_time": ["how much time", "time remaining", "how long", "time left", "what is the time", "how much time is left", "what time is it"],
    ...
    "stop_tts": ["stop", "stop reading", "quiet", "shut up", "pause", "stop talking"],
